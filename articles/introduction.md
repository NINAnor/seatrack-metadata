...
```
    ...
    #> INFO [2026-07-26 14:12:20] Sea track folder set to: /tmp/RtmpAhIEpA/seatrack_vignette_2c5857d1373b/SEATRACK - shared
...
#> INFO [2026-07-26 14:12:21] Get Master import file for colony 'TestColony', use existing paths: TRUE
#> INFO [2026-07-26 14:12:21] Master import file for colony 'TestColony' found at: /tmp/RtmpAhIEpA/seatrack_vignette_2c5857d1373b/SEATRACK - shared/Database/Imports_Metadata/imports_TestColony_2025.xlsx
```
...
#> WARN [2026-07-26 14:12:21] No database connection from which to get models
#> INFO [2026-07-26 14:12:21] Logger ID L1 was retrieved on 2025-01-10 but no startup was added. 
#> This falls into a single open session started on 2024-01-01 . The retrieval may belong to this open session
#> SUCCESS [2026-07-26 14:12:21] Adding 0 new loggers from startup files
```
...
#> SUCCESS [2026-07-26 14:12:21] Appended 1 rows to master metadata. New total is 2 rows.
```
...
#> SUCCESS [2026-07-26 14:12:21] Found unfinished session for logger ID: L1 2025-01-10
#> SUCCESS [2026-07-26 14:12:21] Unfinished session:
#>   logger_serial_no starttime_gmt       intended_species intended_location
#> 1 L1               2024-01-01 00:00:00 bird             TestColony       
#> SUCCESS [2026-07-26 14:12:21] Updated 1 sessions.
#> SUCCESS [2026-07-26 14:12:22] Updated sessions:
...
#> INFO [2026-07-26 14:12:22] Handle partner metadata /tmp/RtmpAhIEpA/seatrack_vignette_2c5857d1373b/Metadata_SEATRACK_2025-TestColony.xlsx 
#> for TestColony /tmp/RtmpAhIEpA/seatrack_vignette_2c5857d1373b/SEATRACK - shared/Database/Imports_Metadata/imports_TestColony_2025.xlsx
#> INFO [2026-07-26 14:12:22] Add missing sessions from start up files
#> WARN [2026-07-26 14:12:22] No database connection from which to get models
#> INFO [2026-07-26 14:12:22] Logger ID L1 was retrieved on 2025-01-10 but no startup was added. 
#> This falls into a single open session started on 2024-01-01 . The retrieval may belong to this open session
#> SUCCESS [2026-07-26 14:12:22] Adding 0 new loggers from startup files
#> INFO [2026-07-26 14:12:22] Check for duplicate sessions
#> INFO [2026-07-26 14:12:22] Append encounter data
#> SUCCESS [2026-07-26 14:12:22] Appended 1 rows to master metadata. New total is 2 rows.
#> INFO [2026-07-26 14:12:22] Update sessions from logger returns
#> SUCCESS [2026-07-26 14:12:22] Found unfinished session for logger ID: L1 2025-01-10
#> SUCCESS [2026-07-26 14:12:22] Unfinished session:
#>   logger_serial_no starttime_gmt       intended_species intended_location
#> 1 L1               2024-01-01 00:00:00 bird             TestColony       
#> SUCCESS [2026-07-26 14:12:22] Updated 1 sessions.
#> SUCCESS [2026-07-26 14:12:22] Updated sessions:
#>   logger_serial_no starttime_gmt       download_type download_date
#> 1 L1               2024-01-01 00:00:00 Downloaded    2025-01-10   
#> INFO [2026-07-26 14:12:22] Finished handling partner metadata /tmp/RtmpAhIEpA/seatrack_vignette_2c5857d1373b/Metadata_SEATRACK_2025-TestColony.xlsx 
#> for TestColony /tmp/RtmpAhIEpA/seatrack_vignette_2c5857d1373b/SEATRACK - shared/Database/Imports_Metadata/imports_TestColony_2025.xlsx
